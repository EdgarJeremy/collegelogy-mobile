    ...
    render() {
        ...
        return (
            <View>
                <ScrollView>
                    <Card>
                        <Card.Title>Register | Collegelogy</Card.Title>
                        <Card.Divider />
                        <View>
                            <ButtonGroup
                                onPress={this.updateType.bind(this)}
                                selectedIndex={type}
                                selectedButtonStyle={{ backgroundColor: 'rgba(26, 188, 156,0.3)' }}
                                buttons={[{
                                    element: () => (
                                        <View>
                                            <Icon name="school" />
                            ...
                            <Button loading={loading} onPress={this.onSubmit.bind(this)} buttonStyle={style.btn} title="Daftar" raised />
                        </View>
                        <Card.Divider />
